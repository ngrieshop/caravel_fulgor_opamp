...
C {lab_wire.sym} 522.5 -700 0 0 {name=l2 sig_type=std_logic lab=vdd
}
C {lab_wire.sym} 525 -640 0 0 {name=l3 sig_type=std_logic lab=iref

}
C {lab_wire.sym} 655 -560 0 0 {name=l4 sig_type=std_logic lab=vp}
C {lab_pin.sym} 1017.5 -640 0 0 {name=l5 sig_type=std_logic lab=iref}
C {lab_wire.sym} 692.5 -160 0 0 {name=l7 sig_type=std_logic lab=vss
}
C {lab_wire.sym} 1227.5 -440 0 0 {name=l8 sig_type=std_logic lab=vout
}
C {lab_wire.sym} 700 -265 0 0 {name=l6 sig_type=std_logic lab=vbn}
...
C {lab_pin.sym} 970 -450 2 0 {name=l9 sig_type=std_logic lab=vdd
}
C {lab_pin.sym} 970 -310 2 0 {name=l10 sig_type=std_logic lab=vss
}
C {sky130_fd_pr/cap_mim_m3_1.sym} 1080 -390 3 0 {name=C1 model=cap_mim_m3_1 W=17.55 L=15 MF=6 spiceprefix=X}
C {iopin.sym} 200 -700 2 0 {name=p1 lab=vdd}
C {iopin.sym} 200 -160 2 0 {name=p2 lab=vss}
C {ipin.sym} 430 -470 0 0 {name=p3 lab=vin_n}
C {ipin.sym} 920 -470 2 0 {name=p4 lab=vin_p}
C {ipin.sym} 200 -560 0 0 {name=p5 lab=iref}
...
C {lab_wire.sym} 880 -390 0 0 {name=l11 sig_type=std_logic lab=voe1}
C {opin.sym} 1280 -440 0 0 {name=p6 lab=vout}
